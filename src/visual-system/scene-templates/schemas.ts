...
/** @internal Creates fresh schema nodes so public template metadata never shares mutable objects. */
export function createBackgroundMediaSchemaProperties(
  options: { readonly stockMediaKeyword?: boolean } = {},
) {
  const mediaKeyword = {
    type: "string",

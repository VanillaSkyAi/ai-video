...
import { externalVideoBackdropCapabilitySource } from "../visual-system/catalog/video-backdrop-capability.js";
...
function templateSource(item: RegistryItem): string {
  ...
  const supportsExternalVideoBackdrop = !!properties.mediaUrl &&
    (mediaTypes == null || mediaTypes.includes("video") || mediaTypes.includes("auto"));

 ...
 * different turns (17 templates hardcoded "#00e5a0", milestone used
...
// ─── Density & motion ──────────────────────────────────────────────
//
// Two dimensions orthogonal to the named preset. `preset` turns "which
// look"; these response "how loud". Splitting them is what lets "make the
